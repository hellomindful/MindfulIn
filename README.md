...
- **AIRRI Readiness Check (free) intake** — No confirmed live Tally form for the free AIRRI Readiness Check under the current architecture — this page uses a temporary on-site Netlify form until a Tally form/URL is provided.
...
- **Assessment-to-Action Mini / Funnel / Signature Assessment Engine checkout links** — No confirmed live Stripe/Kit URLs for Assessment-to-Action Mini ($750), Assessment-to-Action Funnel ($1,500), or Signature Assessment Engine ($3,500+) under the current architecture — CTAs route to an on-site inquiry form until real payment/Kit links are provided.
